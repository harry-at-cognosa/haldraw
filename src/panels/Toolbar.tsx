...
const TOOLS: ToolDef[] = [
  ...
  { id: 'box3d', icon: Cuboid, label: '3D box (external entity)', shortcut: 'B' },
  { id: 'dsbox', icon: Database, label: 'Data store', shortcut: 'X' },
  { id: 'colbox', icon: PanelTop, label: 'Collection', shortcut: 'K' },
